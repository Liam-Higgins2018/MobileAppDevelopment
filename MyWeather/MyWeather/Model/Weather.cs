...
namespace MyWeather.Models
{
    public class Main
    {
        //Getters and Setters and Json properties
        [JsonProperty("temp")]
    ...
    //Gets the weather Json properties
    ...
    //Gets the wind Json properties if detected
    public class Wind
    {
        [JsonProperty("speed")]
    ...
    //Gets Cloud Json properties if present
    public class Clouds
    {
    ...
    // Gets the City's Json proprties
    public class City
    {
        [JsonProperty("id")]
